...
@section('content')
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Philiene</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="btn-group pull-right">
                    <button type="button" class="btn btn-default">
                        <a href="{{ URL::to('/#philiene') }}" target="_blank">
                            Bekijken
                        </a>
                    </button>
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="{{ action('PhilieneController@add', 'text') }}">
                                    <i class="fa fa-pencil-square-o fa-fw"></i> Bericht
                                </a>
                            </li>
                            <li>
                                <a href="{{ action('PhilieneController@add', 'image') }}">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                    		...
                    		<tr>
                    			...
                    			<td>
                    			    <a href="{{ action('PhilieneController@edit', array($bericht->id, $bericht->type)) }}">
